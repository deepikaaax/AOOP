...
class LogCommand implements Command {
    ...
    public void execute(String message) {
        // Use the provided message in your logging logic
...
class Logger {
    ...
    public void addCommand(Command command) {
        if (command instanceof LogCommand) { // Check if command is an instance of LogCommand
    ...
    public void processLogs() {
        for (LogCommand command : commands) { // Iterate over LogCommand objects
